package no.tleirvik.controller;
...
import no.tleirvik.model.filemanagement.EncodeType;
import no.tleirvik.model.filemanagement.FileLoader;
import no.tleirvik.model.filemanagement.FileSaver;
import no.tleirvik.model.filemanagement.ImageType;
...
import no.tleirvik.model.gameoflife.boards.Board.BoardType;
...
import static no.tleirvik.model.util.DialogBoxes.customUtilityDialog;
...
public class FileController {
    ...
    private Object[] loadBoardDialog(Stage owner) {
        ...
        Dialog dialog = customUtilityDialog("Load board", null, gp,
                owner);
