package no.tleirvik.model.gameoflife;


import javafx.scene.control.Alert;
import no.tleirvik.model.util.DialogBoxes;
import java.util.Random;
import no.tleirvik.model.gameoflife.algorithms.Algorithm;
import no.tleirvik.model.gameoflife.algorithms.Default;
import no.tleirvik.model.gameoflife.boards.Board;
import no.tleirvik.model.gameoflife.boards.Board.BoardType;
import no.tleirvik.model.gameoflife.boards.DynamicBoard;
import no.tleirvik.model.gameoflife.boards.FixedBoard;
